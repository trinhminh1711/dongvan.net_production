<template>
    <div class="box-shadow px-3 pb-2 pt-3 mt-3">
        ...
        <div class="post-main__content text-sm ps-5 pe-3 ms-2">
            <div v-html="linkifyText(comment)"></div>
            <div class="post-comment">
                <p class="like-share d-flex gap-4 py-2">
                    ...
                    <span @click="replyCommentFunc()" class="d-flex align-items-center gap-2 text-md cursor-pointer">
