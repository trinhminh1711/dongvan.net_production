<template>
    <div class="main-comment">
        <div class="px-md-3 pb-2 pt-3 mt-3 d-flex align-items-start gap-3"
        ...
        <div class="ms-5-5 reply-wrap">
            <div v-if="commentReply.length > 0" v-for="value in commentReply" class="px-md-3 pb-2 pt-3   reply-thread">
